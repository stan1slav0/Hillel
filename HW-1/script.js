...
const appleFinalPrice =
  applePrice * appleCount - appleResultPercent * appleCount
...
const orangeFinalPrice =
  orangePrice * orangeCount - orangeResultPercent * orangeCount
...
console.log(
  `Final price for ${orangeCount} ${orange} = ${orangeFinalPrice} UAH`
)
console.log(`Final price for ${kiwiCount} ${kiwi} = ${kiwiFinalPrice} UAH`)
console.log(
  `Final price for all products = ${
    appleFinalPrice + orangeFinalPrice + kiwiFinalPrice
  } UAH`
)
...
myList[0].appendChild(newListItem)
